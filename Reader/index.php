        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mt-5 mb-3 clearfix">
                    <h2 class="pull-left">Reader List</h2>
                    <a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Reader</a>
                </div>
                <?php
                // Include config file
                ...
                $sql = "SELECT * FROM bandoc ORDER BY mabd";
